...
file_writer_tool_summary = FileWriterTool(file_name='summary.txt', directory='meeting_minutes_text')
file_writer_tool_action_items = FileWriterTool(file_name='action_items.txt', directory='meeting_minutes_text')
file_writer_tool_sentiment = FileWriterTool(file_name='sentiment.txt', directory='meeting_minutes_text')
...
class MeetingMinutesCrew():
	...
	def meeting_minutes_writing_task(self) -> Task:
		return Task(
			...
			# context=[self.meeting_minutes_summary_task]
		)
